...
const EditProduct = ({ close, data: productData, fetchProductData }) => {
  ...
  return (
    <section className="fixed top-0 bottom-0 left-0 right-0 bg-neutral-800 bg-opacity-70 z-50 p-4">
      <div className="bg-white w-full p-4 max-w-2xl mx-auto rounded overflow-y-auto h-full max-h-[calc(100vh-96px)]">
        <div className="px-6 py-4 bg-white shadow-md flex items-center justify-between">
          <h2 className="font-semibold">Edit Product</h2>
          <button onClick={close} className="hover:text-red-500 hover:scale-110">
            <IoClose size={30} />
          </button>
        </div>
